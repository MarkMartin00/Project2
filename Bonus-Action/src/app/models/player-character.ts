...
export class PlayerCharacter {
    ...
    constructor(
      ...
      this.char_skills = new Map([["acrobatics",0],["animal-handling",0], ["arcana",0], ["athletics",0], ["deception",0], ["history",0], ["insight",0], ["intimidation",0], ["investigation",0], ["medicine",0], ["nature",0], ["perception",0], ["performance",0], ["persuasion",0], ["religion",0], ["sleight-of-hand",0], ["stealth",0], ["survival",0]]);
      this.char_spells = [];
    }
    // SAVING THROWS
    public savingThrow(stat: string) {
      ...
      console.log(`Stat modifier of "${this.getStatModifier(this.char_stats.get(stat))}" applied for a total of "${total}"`)
      return total;
    }
